...
void frontscreen(void)
{
    ...
    glColor3f(0, 0, 1);
    output(-5, 160, " VSM's SOMASHEKHAR R. KOTHIWALE INSTITUTE OF TECHNOLOGY, NIPANI");
    glColor3f(1, 1, 1);
    output(15, 150, "DEPARTMENT OF COMPUTER SCIENCE AND ENGINEERING");
    glColor3f(1, 0, 1);
    ...
    glEnd();
    glColor3f(1, 0, 0);
    output(40, 90, "* Niyaj Kumanali");

    output(40, 80, "* Ruturaj Sadalage");
    glColor3f(1, 0, 1);
    ...
    glEnd();
    glColor3f(0, 1, 0);
    output(60, 50, "Prof. Neelamma S");
    glColor3f(1, 0, 0);
    drawstring(100, 50, "(B.E.)", GLUT_BITMAP_HELVETICA_12);
    glColor3f(1, 0, 0);
    output(60, 40, "Lecturer,Dept. of CSE");
    glColor3f(1, 0, 0);
...
void idle()
{
    if (df == 1)
    {
        ...
        else if ((count < 100) && ((px >= 0 && px <= 4) && (py >= 162 && py <= 168)))
        {
            df = 5;
        }
    }
